...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<h1 class="page-header">사용자 정보 조회 test</h1>
		
		<form id="frm" action="${cp}/user/userModifyForm"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<img src="/user/profileImg?userId=${userVo.userId}" />
				</div>
			</div>
			<div class="form-group">
				<label for="userNm" class="col-sm-3 control-label">첨부파일</label>
				<div class="col-sm-9">
