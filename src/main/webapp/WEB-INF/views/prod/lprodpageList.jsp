...
<body>
			...
			<nav style="text-align: center;">
				<ul class="pagination">
					<c:choose>
						...
						<c:otherwise>
							<li>
								<a href="${request.getContextPath()}/prod/LprodpageList" aria-label="Previous">
								<span aria-hidden="true">&laquo;
								</span>
								</a>
							</li>
					...
					<c:forEach begin="1" end="${lastPage}" var="i">
						...
						<li class="${active}"><a href="${cp }/prod/LprodpageList?page=${i}">${i}</a></li>
					</c:forEach>
					...
					<c:choose>
						...
						<c:otherwise>
							<li><a href="${cp }/prod/LprodpageList?page=${lastPage}"
    ...
    ================================================== -->
		...
		<form id="frm" action="${request.getContextPath() }/prod/prodList"
			method="get">
