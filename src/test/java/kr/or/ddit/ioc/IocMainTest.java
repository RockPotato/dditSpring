...
public class IocMainTest {
	...
	public void testRangerDao() {
		...
		// IRangerDao rangerDao = contexdt.getBean("rangerDao");
	...
	*/
	...
	/**
	* Method : testEqualsSingletonBean
	* 작성자 : PC04
	* 변경이력 :
	...
	*/
	@Test
	public void testEqualsSingletonBean() {
		/***Given***/
		...
		// 스프링 bean scope에서 이야기 하는 singleton은 스프링 이름 단위로 객체가 생성된다.
	...
	@Test
	public void testNotEqualsSingletonBean() {
		/***Given***/
