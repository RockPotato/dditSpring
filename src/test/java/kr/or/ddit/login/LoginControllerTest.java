...
public class LoginControllerTest extends WebTestConfig{
	...
	*/
	...
	public void testLoginProcess_success() throws Exception{
		...
		/***When***/
		MvcResult mvcResult = mockMvc.perform(post("/login").param("userId", "brown").param("pass", "brown1234")
				).andReturn();
	...
	public void testLoginProcess_fail() throws Exception{
		...
		/***When***/
		MvcResult mvcResult = mockMvc.perform(post("/login").param("userId", "brown").param("pass", "brown")
				).andReturn();
